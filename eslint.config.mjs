...
export default EslintConfig.defineConfig([
	...
	EslintConfig.globalIgnores([
		...
		"**/.expo/",
		"./packages/*/lib/",
		"./packages/carbon-react-native/src/carbon-style-sheet/{g,g-object}/{font,spacing,typography}.ts", // generated file
		"./packages/carbon-react-native/src/carbon-style-sheet/color.ts", // generated file
		"./storybook/app/.storybook-rn/storybook.requires.ts", // generated by storybook,
		"./storybook/app/expo-env.d.ts",
		"./storybook/expo/.dist",
	]),
...

	{
		...
		files: [
			"./packages/carbon-react-native/src/**/*.{js,jsx,ts,tsx}",
			"./storybook/.storybook/**/*.{ts,tsx}",
			"./storybook/.storybook-rn/**/*.{ts,tsx}",
