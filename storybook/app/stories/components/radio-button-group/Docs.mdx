...
> You can also get the current selected value to avoid saving the value to another variable with [RadioButtonGroupRef](https://github.com/RakaDoank/carbon-react-native/blob/main/packages/carbon-react-native/src/components/radio-button-group/RadioButtonGroupRef.ts). See [Imperative Handle](#imperative-handle) example
